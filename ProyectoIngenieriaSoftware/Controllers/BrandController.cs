    ...
    public class BrandController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Brands != null ? 
                          ...
                          Problem("Entity set 'StoreContext.Brands'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,Tipo")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Tipo")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
